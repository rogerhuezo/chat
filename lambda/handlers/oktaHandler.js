...
const OKTA_TRIGGER_KEYWORDS = [
  ...
  'password not working', 'password isnt working', "password isn't working",
  'password issue', 'password problem', 'cant login', "can't login",
  'cannot login', 'cant log in', "can't log in", 'cannot log in',
  'cant sign in', "can't sign in", 'cannot sign in',
  'login issue', 'login problem', 'sign in issue', 'sign in problem',
  // Spanish
  ...
  // Spanish — broader
  'no puede entrar', 'no puede iniciar sesion', 'problema con contraseña',
  'problema de acceso', 'no funciona la contraseña'
];
